...
const BLOG = {
  ...
  SINCE: process.env.NEXT_SINCE || 2017, // e.g if leave this empty, current year will be used.
  ...
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || '欢迎光临，本公司专业生产和销售高品质的变频器、软启动器和高低压成套设备，产品销往世界各地。我们欢迎全球代理商、分销商、零售商和其他合作伙伴加入我们，共同发展互惠互利的业务关系。我们的产品已经受到许多国家和地区客户的欢迎，我们期待着进一步扩大我们的业务范围。',

  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || true, // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。

  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '森阔机电', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '软启动变频器厂家', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://notion.nav8.top', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '软启动器厂家,软启动柜厂家,变频器厂家', // 网站关键词 英文逗号隔开

  // 社交链接，不需要可留空白，例如 CONTACT_WEIBO:''
  CONTACT_EMAIL: process.env.NEXT_PUBLIC_CONTACT_EMAIL || 'admin@nav8.top', // 邮箱地址 例如mail@tangly1024.com
  ...
  CONTACT_ZHIHU: process.env.NEXT_PUBLIC_CONTACT_ZHIHU || 'senkuojidian', // 知乎主页
  CONTACT_PHONE: process.env.NEXT_PUBLIC_CONTACT_PHONE || '15064999739', // 手机号码

  NOTION_HOST: process.env.NEXT_PUBLIC_NOTION_HOST || 'https://www.notion.so', // Notion域名，您可以选择用自己的域名进行反向代理，如果不懂得什么是反向代理，请勿修改此项

  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || 'https://blog.lyskjd.com/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  ...
  COMMENT_TWIKOO_CDN_URL: process.env.NEXT_PUBLIC_COMMENT_TWIKOO_CDN_URL || 'https://cdn.staticfile.org/twikoo/1.6.30/twikoo.min.js', // twikoo客户端cdn
